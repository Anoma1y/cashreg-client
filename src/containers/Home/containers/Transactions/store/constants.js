...
export const SET_TRANSACTIONS = 'Tranasctions/SET_TRANSACTIONS';
export const SET_TRANSACTION_INFO = 'Tranasctions/SET_TRANSACTION_INFO';
export const SET_TRANSACTION_ORDER = 'Tranasctions/SET_TRANSACTION_ORDER';
export const SET_CONTRAGENTS = 'Tranasctions/SET_CONTRAGENTS';
export const PULL_DATA = 'Tranasctions/PULL_DATA';
export const PULL_CATEGORIES = 'Tranasctions/PULL_CATEGORIES';
